...
public class DemandeAchatCriteria implements Serializable, Criteria {
    ...
    public StatutDAFilter getStatutDA() {
        return statutDA;
    }

    public void setStatutDA(StatutDAFilter statutDA) {
        this.statutDA = statutDA;
    }

    private StatutDAFilter statutDA;
   ...
   //     this.datedemande = other.datedemande == null ? null : other.datedemande.copy();
        ...
        this.statutDA = other.statutDA == null ? null : other.statutDA.copy();
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(description, that.description) && Objects.equals(statutDA, that.statutDA) &&
    ...
    public static class StatutDAFilter extends Filter<StatutDA> {
        public StatutDAFilter() {};
        public StatutDAFilter(DemandeAchatCriteria.StatutDAFilter filter) {
            super(filter);
        };
        @Override
        public DemandeAchatCriteria.StatutDAFilter copy() {
            return new DemandeAchatCriteria.StatutDAFilter(this);
