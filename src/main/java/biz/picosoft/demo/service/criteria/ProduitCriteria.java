...
public class ProduitCriteria implements Serializable, Criteria {
    ...
    private LongFilter quantitedemandeur;
    ...
    public ProduitCriteria(ProduitCriteria other) {
        ...
        this.quantitedemandeur = other.quantitedemandeur == null ? null : other.quantitedemandeur.copy();
    ...
    public LongFilter getQuantitedemandeur() {
        return quantitedemandeur;
    }

    public void setQuantitedemandeur(LongFilter quantitedemandeur) {
    ...
    public boolean equals(Object o) {
        ...
        return (
                Objects.equals(id, that.id) &&
                        ...
                        Objects.equals(quantitedemandeur, that.quantitedemandeur) &&
    ...
    public String toString() {
        return "ProduitCriteria{" +
                ...
                (quantitedemandeur != null ? "quantitedemandeur=" + quantitedemandeur + ", " : "") +
