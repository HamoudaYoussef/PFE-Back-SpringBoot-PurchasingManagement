...
public class DemandeAchatOutputDTO extends ObjectsDTO implements Serializable
{
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DemandeAchatOutputDTO)) {
            return false;
        }

        DemandeAchatOutputDTO demandeAchatOutputDTO = (DemandeAchatOutputDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, demandeAchatOutputDTO.id);
    }
