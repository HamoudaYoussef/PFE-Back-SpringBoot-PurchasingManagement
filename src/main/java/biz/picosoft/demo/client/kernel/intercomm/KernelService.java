...
import biz.picosoft.demo.domain.ennumeration.StatutClass;
...
public class KernelService {
    public static final String demande_achat_canCreateDA = "demande_achat_canCreateDA";
    public static final String demande_achat_canValidDA = "demande_achat_canValidDA";
    public static final String canCreateBonCommande_achat = "canCreateBonCommande_achat";
    ...
    public List<String> roles = Arrays.asList(
            demande_achat_canCreateDA,canCreateBonCommande_achat);

    public static final String SEQ_DemandeAchat = "seq_demande_achat";
    public static final String SEQ_BonCommande = "seq_bon_commande_achat";
...
//    public List<String> sequanceList = new ArrayList<>(Arrays.asList(SEQ_DemandeOpp));
    public List<String> sequanceList = new ArrayList<>(Arrays.asList(SEQ_DemandeAchat, SEQ_BonCommande));
    ...
    public void addClassDemande() {
        try {
            ...
            initClass.setSimpleName(DemandeAchat.class.getSimpleName());
            initClass.setName(DemandeAchat.class.getName());

            HashMap<String, String> event = new HashMap<>();
            HashMap<String, String> state = new HashMap<>();
/*
            for (StatutDA s : StatutDA.values()) {
...
//            }
    ...
    @Bean
    public void addClassBonC() {
        try {
            InitClass initClass = new InitClass();
            initClass.setSimpleName(BonCommande.class.getSimpleName());
            initClass.setName(BonCommande.class.getName());

            HashMap<String, String> event = new HashMap<>();
            HashMap<String, String> state = new HashMap<>();

           for (StatutClass s : StatutClass.values()) {
                state.put(s.name(), s.getLabel());
            }
//*            for (DemandeEvent s : DemandeEvent.values()) {
//                event.put(s.name(), s.getLabel());
//            }*/
            initClass.setEvent(event);
            initClass.setState(state);
             initClass.setDefaultState(StatutClass.DRAFT.name());
